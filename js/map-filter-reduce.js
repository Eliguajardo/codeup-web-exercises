// Create a file named map-filter-reduce.js in your js directory and copy the
// users data below into it.
...
var filterUser = users.filter(user=> user.languages.length >= 3);
console.log(filterUser);

var emailsMap = users.map(function(user) {
    return user.email;
});
console.log(emailsMap);

const reduceYears = users.reduce((yearsOfExperience) => {
